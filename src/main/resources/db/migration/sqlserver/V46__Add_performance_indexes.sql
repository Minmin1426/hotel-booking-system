...
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'idx_rooms_hotel_avail' AND object_id = OBJECT_ID('rooms'))
    CREATE INDEX idx_rooms_hotel_avail ON rooms (hotel_id, is_available);
