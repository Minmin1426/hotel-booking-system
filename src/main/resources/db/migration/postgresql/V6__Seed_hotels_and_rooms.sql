...
-- Description: Seed sample hotels, hotel images, and rooms for Search & Discovery testing (PostgreSQL)

-- 1. Insert Hotels
INSERT INTO hotels (name, location, description, rating, is_active, created_at, updated_at) VALUES
('InterContinental Landmark72', 'Keangnam Landmark72, Hanoi, Vietnam', 'Spectacular Hanoi city views from the tallest luxury hotel in Vietnam.', 4.9, TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('Sheraton Hanoi Westlake', 'K Nghi Tam, Tay Ho, Hanoi, Vietnam', 'Scenic lakeside luxury resort offering a peaceful escape in Hanoi.', 4.7, TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('Hilton Saigon Riverview', 'Me Linh Square, District 1, Ho Chi Minh City, Vietnam', 'Premium business and leisure hotel overlooking the historic Saigon River.', 4.6, TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('Pullman Danang Beach Resort', 'Vo Nguyen Giap, Ngu Hanh Son, Da Nang, Vietnam', 'Stunning beachfront resort with premium amenities, infinity pool, and luxury spa.', 4.8, TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

-- 2. Insert Hotel Images
